...
- Any custom keyword arguments are put as SLURM parameters within internal batch file. This way, users have full control over hardware requirements, partitions, wall time, etc.
