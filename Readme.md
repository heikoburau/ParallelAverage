...
It basically converts a Python function call that performs the calculation into a [SLURM](https://slurm.schedmd.com/) batch script, sends it to the cluster, and let all the results of the job be written to the file system.
...
- If different parameters are used, a new job will be submitted and a new entry will be added to a database. 
